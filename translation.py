class Translation(object):
    START_TEXT = """Hi!
please read the TnC before proceeding: https://t.me/jetbots
...
if you do not trust this bot dev, please contact the owner @jettastic
also channel- @jetbots if you want any bot for personal use then contact @jettastic
